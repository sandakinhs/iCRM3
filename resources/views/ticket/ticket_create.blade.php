...
@section('navbar')
    ...
    $(document).ready(function(){
        $("#content").load("../tickets/ticket_load");
    });
...
if(isset($_POST['ticket'])){
    ...
    echo '<script>window.location.href="'.$_SERVER['PHP_SELF'].'?loc=ticket&action=view&alert=successful";</script> ';
}
...
<form id="form" method="post" action="../ticket">


    <div id='main-wrapper-contact'>
        <div id="tabs">
            <ul>
                <li><a href="#Contact-Edit">Add Ticket</a></li>
            </ul>
            <div id="Contact-Edit">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a>First Name:</a></td><td>
                                <a><input type="text" id="contact_firstname" name="contact_firstname" value="<?php echo $contact_firstname; ?>" required="required" readOnly="readOnly"></a>
                            </td>
