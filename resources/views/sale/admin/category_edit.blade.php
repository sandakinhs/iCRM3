...
<script type="text/javascript">
    window.location="<?php $_SERVER['PHP_SELF']?>?loc=category&action=view&alert=successful";
</script>
<?php
...
?>
<script type="text/javascript">
    window.location="<?php $_SERVER['PHP_SELF']?>?loc=category&action=add&alert=error";
</script>
<?php
                ...
                <fieldset class="scheduler-border">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><a>&nbsp Level:</a></td><td> <a1><input type="text" id="level" name="level" value="<?php echo $row->level; ?>"></a1> </td>
                            <td>&nbsp</td>
